...
export function parseTicks(file, wanted_props, wanted_ticks, wanted_players, struct_of_arrays, order_by_steamid, prop_states) {
    ...
    const ret = wasm.parseTicks(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, isLikeNone(struct_of_arrays) ? 0xFFFFFF : struct_of_arrays ? 1 : 0, isLikeNone(order_by_steamid) ? 0xFFFFFF : order_by_steamid ? 1 : 0, ptr4, len4);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_wantedpropstate_unwrap = function(arg0) {
        const ret = WantedPropState.__unwrap(arg0);
        return ret;
    };
