...
export function __wbg_wantedpropstate_free(a: number, b: number): void;
...
export function parseTicks(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number): void;
...
export function parseHeader(a: number, b: number, c: number): void;
